...
比较内存斜率与 cleanup rate，而不是只看终点；fault 会制造单调增长。
...
```bash
python3 scripts/agent_performance_lab.py --manifest manifests/TD-AP07-lab.json --mode baseline
python3 scripts/agent_performance_lab.py --manifest manifests/TD-AP07-lab.json --mode fault
python3 scripts/agent_performance_lab.py --manifest manifests/TD-AP07-lab.json --mode repair
python3 scripts/agent_performance_lab.py --manifest manifests/TD-AP07-lab.json --mode cycle
```
