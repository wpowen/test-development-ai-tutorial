...
`TD-F01 → TD-P01–TD-P08`，以及 `TD-AP01–TD-AP08`。

第一条路线覆盖职业现实、需求依据、需求契约、评审、风险、Oracle、自动化适配器、执行证据和变更回归。第二条路线覆盖 Agent 工作负载、指标树、Trace、压测架构、可运行 SOP、故障诊断、SLO、告警和降级。17 页均有正文、练习、完成检查、来源和证据边界；正文完成不等于真实企业或学习效果已验证。内部知识树继续维护其他命题，但未通过逐题研究与教材门禁的内容不会出现在公开课程。
