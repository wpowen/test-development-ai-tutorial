...
# The course package contains instructor contract, provenance, evidence and
# video files in addition to the learner-facing distribution.  Only the
# explicit learner-materials subtree is published as the downloadable bundle.
ROOT = COURSE_ROOT / "learner-materials"
OUTPUT_ROOT = COURSE_ROOT.parents[1]
